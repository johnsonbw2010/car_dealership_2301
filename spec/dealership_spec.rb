...
RSpec.describe Dealership do
  ...
  it 'can assess total value of inventory' do
    ...
    expect(dealership.has_inventory?).to eq(true)
    expect(dealership.total_value).to eq ("$156,000")
  end
  ...
  it 'can list details of dealership' do
    ...
    dealership.add_car(car_3)
    dealership.add_car(car_4)
    expect(dealership.details).to eq("Total value is $156,000, and the dealership is located at 123 Main Street")
  end

  it 'can find average cost of inventory' do
    dealership = Dealership.new("Acme Auto", "123 Main Street")
    car_1 = Car.new("Ford Mustang", 1500, 36)
    car_2 = Car.new("Toyota Prius", 1000, 48)
    car_3 = Car.new("Toyota Tercel", 500, 48)
